...
const answerFormats={
  1:'Выбор двух позиций из пяти; номера в порядке возрастания',
  2:'Выбор трёх позиций из пяти и запись в требуемой последовательности',
  3:'Выбор двух позиций из пяти; номера в порядке возрастания',
  4:'Выбор двух позиций из пяти; номера в порядке возрастания',
  5:'Соответствие трёх позиций элементам пронумерованного перечня',
  6:'Две упорядоченные позиции X и Y из пяти вариантов',
  7:'Соответствие: 4 позиции слева и 5 вариантов справа',
  8:'Соответствие: 4 позиции слева и 6 вариантов справа',
  9:'Две упорядоченные позиции X и Y из пяти вариантов',
 10:'Соответствие: 3 позиции слева и 4 варианта справа',
 11:'Выбор двух позиций из пяти; номера в порядке возрастания',
 12:'Выбор всех подходящих позиций из пяти',
 13:'Выбор двух позиций из пяти; номера в порядке возрастания',
 14:'Соответствие: 4 позиции слева и 6 вариантов справа',
 15:'Соответствие: 4 позиции слева и 6 вариантов справа',
 16:'Две упорядоченные позиции X и Y из пяти вариантов',
 17:'Соответствие: 3 позиции слева и 4 варианта справа',
 18:'Выбор всех подходящих позиций из пяти',
 19:'Соответствие: 3 позиции слева и 4 варианта справа',
 20:'Соответствие: 3 позиции слева и 4 варианта справа',
 21:'Последовательность четырёх позиций',
 22:'Соответствие: 4 позиции слева и 3 варианта справа',
 23:'Две упорядоченные позиции X и Y из шести вариантов',
 24:'Соответствие: 4 позиции слева и 5 вариантов справа',
 25:'Соответствие: 3 позиции слева и 4 варианта справа',
 26:'Числовой краткий ответ',
 27:'Числовой краткий ответ',
 28:'Числовой краткий ответ',
 29:'Развёрнутый ответ: электронный баланс и ОВР',
 30:'Развёрнутый ответ: молекулярное и сокращённое ионное уравнения',
 31:'Развёрнутый ответ: цепочка неорганических превращений',
 32:'Развёрнутый ответ: цепочка органических превращений',
 33:'Развёрнутый ответ: установление молекулярной/структурной формулы',
 34:'Развёрнутый расчёт'
};
...
const registry={
  ...
  sourceLabel:'Структура линий и критерии сверены с проектом КИМ ЕГЭ-2027 ФИПИ; тренировочные задания проходят строгую проверку формата линии.',
