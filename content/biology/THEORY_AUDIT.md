...
- topic: bio-human-tissues-organism
...
## Аудит пользовательской навигации PHASE 3

Корневая причина: импортёр публиковал и обновлял topics из актуального `course.json`, но никогда не снимал `published` с topics, удалённых из новой редакции section. Поэтому после импорта в БД одновременно оставались 13 актуальных тем и 6 прежних пустых контейнеров `bio-human-1` … `bio-human-6`. Section API честно возвращал все 19 опубликованных root topics, а frontend показывал шесть технических контейнеров как пустые вкладки. Lessons и question refs в актуальных 13 topics были исправны; дефект находился в синхронизации удалённых navigation entities.

| TITLE | DIRECT LESSONS | CHILD TOPICS | TOTAL REACHABLE LESSONS | QUESTIONS | UI STATUS |
|---|---:|---:|---:|---:|---|
| Ткани и организм человека | 7 | 0 | 7 | 35 | reachable, non-empty |
| Опорно-двигательная система | 6 | 0 | 6 | 30 | reachable, non-empty |
| Кровь, иммунитет и лимфа | 5 | 0 | 5 | 25 | reachable, non-empty |
| Сердце и кровообращение | 5 | 0 | 5 | 25 | reachable, non-empty |
| Дыхательная система | 5 | 0 | 5 | 25 | reachable, non-empty |
| Пищеварительная система | 5 | 0 | 5 | 25 | reachable, non-empty |
| Обмен веществ и витамины | 3 | 0 | 3 | 15 | reachable, non-empty |
| Выделительная система | 4 | 0 | 4 | 20 | reachable, non-empty |
| Кожа и терморегуляция | 2 | 0 | 2 | 10 | reachable, non-empty |
| Нервная система | 5 | 0 | 5 | 25 | reachable, non-empty |
| Эндокринная система | 3 | 0 | 3 | 15 | reachable, non-empty |
| Органы чувств и высшая нервная деятельность | 8 | 0 | 8 | 40 | reachable, non-empty |
| Размножение и развитие человека | 5 | 0 | 5 | 25 | reachable, non-empty |

- BEFORE: visible root topics 19; empty visible topics 6; reachable current lessons 63, но шесть маршрутов открывали пустой экран.
- AFTER: visible root topics 13; empty visible topics 0; reachable lessons 63/63; orphan lessons 0; duplicate lesson refs 0; questions with valid reachable lesson 315/315; broken API routes 0.
- Migration safety: при редакционном переносе lesson между topics импортёр находит существующую строку по стабильному slug и меняет `topic_id`, сохраняя lesson ID, progress и attempts. После импорта отсутствующие в section topics получают `published=FALSE`.
