...
const groups=[
 ...
 {slug:'chemistry-processes',title:'Химические реакции и закономерности',description:'Классификация реакций, скорость, тепловые эффекты, равновесие, растворы, ОВР и электролиз.',lines:[17,18,19,20,21,22,29]},
 {slug:'chemistry-calculations',title:'Расчёты в химии',description:'Стехиометрия, растворы, термохимия, выход продукта, смеси и вывод формулы.',lines:[23,26,27,28,34]},
 {slug:'chemistry-applied',title:'Практическая и промышленная химия',description:'Безопасность, здоровье, экология, сырьё, энергетика и химическая технология.',lines:[25]}
];
