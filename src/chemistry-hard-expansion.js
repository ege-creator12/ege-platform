...
const inorganicChains=[
 ...
 {chain:'SO3 → H2SO4 → Na2SO4',x:'H2O',y:'NaOH',wrong:['H2','Cl2','NH3']},
 {chain:'Na → NaOH → Na2CO3',x:'H2O',y:'CO2',wrong:['HCl','O2','Cl2']},
 {chain:'CuO → CuCl2 → Cu(OH)2',x:'HCl',y:'NaOH',wrong:['H2SO4','O2','CO2']},
 {chain:'Mg → MgO → MgCl2',x:'O2, t',y:'HCl',wrong:['NaOH','H2O','CO2']},
 {chain:'Cl2 → HCl → AgCl',x:'H2, hν',y:'AgNO3',wrong:['NaOH','O2','H2O']},
 {chain:'Na2SO3 → SO2 → H2SO4',x:'HCl',y:'O2 + H2O',wrong:['NaOH','H2','Cl2']}
];
...
const hydrocarbonCases=[
 ...
 {prompt:'Выберите вещества, в молекулах которых присутствуют две двойные связи C=C.',correct:['бутадиен-1,3','изопрен'],wrong:['этен','этин','бензол']},
 {prompt:'Выберите углеводороды, относящиеся к алкинам.',correct:['этин','пропин'],wrong:['этен','пропен','бензол']},
 {prompt:'Выберите углеводороды, относящиеся к аренам.',correct:['бензол','толуол'],wrong:['циклогексан','этен','этин']},
 {prompt:'Выберите углеводороды, которые содержат одну тройную связь C≡C.',correct:['этин','пропин'],wrong:['этен','бутадиен-1,3','бензол']},
 {prompt:'Выберите углеводороды, которые при присоединении одного моля H2 могут образовать алкен.',correct:['этин','пропин'],wrong:['этен','этан','бензол']}
];
function line12(n){
...
const line13Cases=[
 ...
 {prompt:'Выберите два вещества, которые дают ярко-синее окрашивание со свежеполученным Cu(OH)2 при комнатной температуре.',correct:['глюкоза','фруктоза'],wrong:['метиламин','этаналь','этан']},
 {prompt:'Выберите два вещества, которые являются аминокислотами.',correct:['глицин','аланин'],wrong:['анилин','этанол','уксусная кислота']},
 {prompt:'Выберите два вещества, молекулы которых содержат аминогруппу −NH2.',correct:['метиламин','глицин'],wrong:['глюкоза','этанол','уксусная кислота']},
 {prompt:'Выберите два вещества, способные реагировать с NaOH благодаря кислотной функциональной группе.',correct:['глицин','аланин'],wrong:['метиламин','этиламин','глюкоза']},
 {prompt:'Выберите два вещества, которые могут реагировать с HCl по атому азота.',correct:['метиламин','глицин'],wrong:['глюкоза','этановая кислота','этанол']},
 {prompt:'Выберите два вещества, относящиеся к полисахаридам.',correct:['крахмал','целлюлоза'],wrong:['глюкоза','фруктоза','сахароза']},
 {prompt:'Выберите два вещества, которые являются азотсодержащими органическими соединениями.',correct:['анилин','глицин'],wrong:['глюкоза','этанол','этановая кислота']},
 {prompt:'Выберите два вещества, способные образовывать соли с сильными кислотами.',correct:['метиламин','этиламин'],wrong:['глюкоза','этанол','этаналь']},
 {prompt:'Выберите два вещества, являющиеся природными биополимерами.',correct:['белок','целлюлоза'],wrong:['глюкоза','сахароза','этилен']},
 {prompt:'Выберите два вещества, при гидролизе которых могут образовываться мономерные звенья.',correct:['крахмал','белок'],wrong:['глюкоза','глицин','метиламин']}
];
function line13(n){
...
const organicChains=[
 ...
 {chain:'C2H2 → C2H4 → C2H5Br',x:'H2, Ni (1 моль)',y:'HBr',wrong:['Br2','NaOH','CuO']},
 {chain:'C2H4 → C2H4Br2 → HOCH2CH2OH',x:'Br2',y:'KOH(водн.)',wrong:['H2','HCl','CuO']},
 {chain:'C2H5OH → C2H4 → C2H5Cl',x:'H2SO4(конц.), 170°C',y:'HCl',wrong:['Br2','NaOH','H2']},
 {chain:'CH3COOH → CH3COONa → CH4',x:'NaOH',y:'NaOH/CaO, t',wrong:['H2','Br2','CuO']},
 {chain:'C6H5NH2 → C6H5NH3Cl → C6H5NH2',x:'HCl',y:'NaOH',wrong:['Br2','H2','CuO']},
 {chain:'CH3CH2OH → CH3COOH → CH3COOC2H5',x:'[O]',y:'C2H5OH, H+',wrong:['H2','Br2','NaOH']}
];
...
const rateCases=[
 ...
 {system:'реакция мрамора с HCl',correct:['измельчить мрамор','повысить концентрацию HCl'],wrong:['охладить смесь','разбавить кислоту','увеличить размер кусков мрамора']},
 {system:'окисление H2 кислородом',correct:['повысить температуру','увеличить концентрацию O2'],wrong:['охладить смесь','уменьшить концентрацию H2','снизить давление реагирующих газов']},
 {system:'реакция Al с раствором щёлочи после удаления оксидной плёнки',correct:['повысить температуру','увеличить концентрацию щёлочи'],wrong:['охладить смесь','разбавить щёлочь','уменьшить площадь поверхности Al']},
 {system:'гидрирование этена на Ni',correct:['увеличить парциальное давление H2','повысить температуру в кинетическом опыте'],wrong:['уменьшить концентрацию этена','охладить смесь','удалить катализатор']},
 {system:'разложение CaCO3 при нагревании',correct:['повысить температуру','измельчить твёрдый CaCO3'],wrong:['охладить образец','увеличить размер кусков','снизить температуру']}
];
function line18(n){
...
function line23(n){
 ...
 const a0=Number((2.0+0.2*((cycle*7+N)%13)).toFixed(1)),b0=Number((2.4+0.2*((cycle*11+N)%17)).toFixed(1)),extent=Number((0.1+0.1*((cycle*5+N)%4)).toFixed(1));
