...
function auditBiologyTheory(course,publicRoot=resolve(ROOT,'public')){
 ...
 const expectedHumanTitles=['Ткани и организм человека','Опорно-двигательная система','Кровь, иммунитет и лимфа','Сердце и кровообращение','Дыхательная система','Пищеварительная система','Обмен веществ и витамины','Выделительная система','Кожа и терморегуляция','Нервная система','Эндокринная система','Органы чувств и высшая нервная деятельность','Размножение и развитие человека'];
