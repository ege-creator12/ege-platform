...
> Исторический отчёт. Метки FULL/approved ниже не доказывают полноту курса: повторная содержательная проверка обнаружила пропуски. Обновление от 2026-09-06 затронуло 185 уроков; фактические изменения и пределы проверки перечислены в [COMPLETENESS_REVIEW.md](COMPLETENESS_REVIEW.md), сопоставление 39 кодов официального PDF — в [FIPI_2027_COVERAGE.md](FIPI_2027_COVERAGE.md). Автотесты проверяют целостность, но не заменяют предметную экспертизу.
