...
const oxidationCases=[
 {el:'S',os:'+6',correct:['SO3','H2SO4'],wrong:['H2S','SO2','S']},
 {el:'S',os:'+4',correct:['SO2','Na2SO3'],wrong:['H2SO4','H2S','S']},
 {el:'N',os:'+5',correct:['HNO3','N2O5'],wrong:['NH3','N2','NO2']},
 {el:'N',os:'+3',correct:['HNO2','N2O3'],wrong:['HNO3','NH3','N2']},
 {el:'Cl',os:'+7',correct:['HClO4','KClO4'],wrong:['HCl','Cl2','HClO3']},
 {el:'Cl',os:'+5',correct:['HClO3','KClO3'],wrong:['HClO4','HCl','Cl2']},
 {el:'C',os:'+4',correct:['CO2','Na2CO3'],wrong:['CO','CH4','C']},
 {el:'C',os:'−4',correct:['CH4','Al4C3'],wrong:['CO','CO2','C']},
 {el:'Mn',os:'+7',correct:['KMnO4','Mn2O7'],wrong:['MnO2','MnO','Mn']},
 {el:'Cr',os:'+6',correct:['K2Cr2O7','CrO3'],wrong:['Cr2O3','CrCl3','Cr']},
 {el:'Fe',os:'+3',correct:['FeCl3','Fe2O3'],wrong:['FeCl2','FeO','Fe']},
 {el:'P',os:'+5',correct:['H3PO4','P2O5'],wrong:['PH3','P','H3PO3']},
 {el:'P',os:'+3',correct:['H3PO3','PCl3'],wrong:['H3PO4','PH3','P']},
 {el:'Si',os:'+4',correct:['SiO2','Na2SiO3'],wrong:['SiH4','Si','Mg2Si']}
];
function line3(n){
 const N=Math.max(1,Number(n)||1),c=oxidationCases[(N-1)%oxidationCases.length],w=rotate(c.wrong,Math.floor((N-1)/oxidationCases.length)+1);
